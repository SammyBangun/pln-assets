...
function submit() {
  ...
  formData.append("old_serial_number", props.item.serial_number);
  ...
  if (form.gambar instanceof File) {
    ...
    formData.append("gambar", gambarLama);
  }
          ...
          <div>
            ...
            <div v-if="gambarPreview" class="mt-4 mx-auto">
              ...
              <img :src="gambarPreview" alt="Preview Gambar"
                class="max-w-48 h-auto mx-auto text-center rounded-lg shadow-md">
            </div>
          </div>
